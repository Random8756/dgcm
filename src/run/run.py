...
def run(_run, _config, _log):
    ...
    unique_token = "{}__{}__{}__seed_{}".format(args.name, datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S"), args.env_args['map_name'],_config["seed"])
...
def run_sequential(args, logger):
    ...
    scheme = {
        ...
        "adj_matrix":{"vshape":(env_info["n_agents"],),"group":"agents","dtype":th.float},
    }
    groups = {
